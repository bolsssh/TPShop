...
namespace IIS.Shop
{
    ...
    public class Order : IIS.Shop.Document
    {
        ...
        [DataServiceExpression(typeof(SQLDataService), "SELECT SUM(PriceWTaxes * Amount) FROM OrderItem WHERE OrderItem.Order_m0 = STORMM" + "ainObjectKey")]
        ...
        [PropertyStorage(new string[] { "Manager"})]
        [NotNull()]
